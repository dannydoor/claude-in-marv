...
If lineage cannot establish origin, ask the user for a complete run-scoped assertion rather than inventing one.
...
State user assertions, snapshot skew, ambiguity, and saturation wherever they affect the result ([claim-limits](../references/reporting.md#claim-limits)).
