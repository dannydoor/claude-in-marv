...
**Evidence-backed revision.** Revisit member or residue selection when the measurements justify it, preserving the source selection and recording what changed, why, and what the comparison showed ([iteration-budget](../references/orchestration.md#iteration-budget)).
