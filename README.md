...
1. [Download `marv-api-v0.2.0.mcpb`](https://github.com/dannydoor/claude-in-marv/releases/download/v2.1.2/marv-api-v0.2.0.mcpb) from this plugin's release.
...
Plugin 2.1.2 requires MCPB 0.2.0.
Both installable files are produced from the same checked-in MCP runtime and published together.

You can alternatively [download the `.plugin` file](https://github.com/dannydoor/claude-in-marv/releases/download/v2.1.2/claude-in-marv-v2.1.2.plugin) from the same release and upload it from the Plugins page.
